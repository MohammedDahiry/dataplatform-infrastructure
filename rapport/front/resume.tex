...
\noindent\colorbox{lightpanel}{%
  \parbox{\dimexpr\linewidth-2\fboxsep\relax}{%
    \textbf{Mots-clés :} Cloud Data Platform, Lakehouse, Data Lake, AWS EKS, pipeline data, Informix CBS, ONE, SmartStream, fichiers métiers, BI, dbt, Apache Spark, monitoring, logging, dashboarding, sécurité des données.
  }%
}
\endgroup
