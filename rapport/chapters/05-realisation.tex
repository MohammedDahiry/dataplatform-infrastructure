...
La capture du NAT Gateway montre le composant chargé de fournir une sortie Internet aux ressources privées sans les exposer directement. En environnement \texttt{dev}, l'utilisation d'un NAT unique réduit les coûts tout en conservant le principe d'un accès sortant contrôlé pour les nœuds et workloads.
