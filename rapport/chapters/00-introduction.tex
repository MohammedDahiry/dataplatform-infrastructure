...
\begin{itemize}[leftmargin=1.2cm, itemsep=0.28em]
    \item le chapitre 1 présente l'organisme d'accueil, le contexte client et la méthodologie de travail ;
    \item le chapitre 2 introduit les concepts et technologies nécessaires à la compréhension de la solution ;
    \item le chapitre 3 formalise les besoins fonctionnels et non fonctionnels ;
    \item le chapitre 4 décrit la conception globale et les choix d'architecture ;
    \item le chapitre 5 détaille la réalisation technique et l'état d'avancement ;
    \item le chapitre 6 conclut le travail et propose les perspectives d'amélioration.
\end{itemize}
