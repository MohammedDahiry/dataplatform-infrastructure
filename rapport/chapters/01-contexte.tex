...
\node[root] (root) at (7.2,0) {Plateforme de données Cloud\\cible};
\draw[link] (root.south) -- (7.2,-1.05);
\draw[link] (0.8,-1.05) -- (13.6,-1.05);

\node[bluecat]   (sources) at (1.2,-1.85) {Sources\\hétérogènes};
\node[greencat]  (pipeline) at (4.2,-1.85) {Pipeline\\de données};
...
\node[greenitem] (p1) at (4.2,-3.05) {Ingestion en lots et flux};
...
\node[purpleitem] (g2) at (10.2,-4.08) {Hachage des données sensibles};
...
\node[reditem] (o3) at (13.2,-5.11) {Tableaux de bord BI et indicateurs métier};
